		...
		<section className="relative min-h-screen flex items-center justify-center overflow-hidden">
			...
			<div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
				...
				<p className="text-xl lg:text-2xl leading-relaxed font-outfit font-medium mb-12 max-w-4xl mx-auto text-gray-700">
					...
					, we are the bridge between vision and manifestation. Every pixel,
					every interaction, every experience is crafted to transform the way
					humans connect with technology.
				</p>
