...
const ServicesPanel = ({ dropdown, navbarTheme, onLinkClick }: { dropdown: DropdownData, navbarTheme: "dark" | "light", onLinkClick: () => void }) => (
	<div className="flex">
		{/* Left side - Content */}
		<div className="flex-1 p-6">
			<div className="mb-4">
				<h3 className={`font-russo text-2xl font-bold mb-2 ${
...
const DefaultPanel = ({ dropdown, navbarTheme, onLinkClick }: { dropdown: DropdownData, navbarTheme: "dark" | "light", onLinkClick: () => void }) => (
	<div className="flex">
		{/* Left side - Content */}
		<div className="flex-1 p-6">
			<div className="mb-4">
				<h3 className={`font-russo text-xl font-bold mb-2 ${
					navbarTheme === 'dark' ? 'text-white' : 'text-black'
				}`}>
					{dropdown.title}
				</h3>
...
export default function DropdownPanel({
	...
	const renderContent = () => {
		switch (type) {
			case "story":
				return <StoryPanel dropdown={dropdown} navbarTheme={navbarTheme} onLinkClick={onLinkClick} />;
			case "services":
				return <ServicesPanel dropdown={dropdown} navbarTheme={navbarTheme} onLinkClick={onLinkClick} />;
			default:
				return <DefaultPanel dropdown={dropdown} navbarTheme={navbarTheme} onLinkClick={onLinkClick} />;
		}
	};
	...
	return (
		...
		>
			<div className={`rounded-2xl border backdrop-blur-2xl shadow-2xl overflow-hidden transition-all duration-200 ${
				navbarTheme === 'dark' 
